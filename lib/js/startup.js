...
var popup_buttons = document.querySelectorAll('.popup_button');
for (var i = 0; i < popup_buttons.length; i++) {
    popup_buttons[i].addEventListener('click', function () {
        document.getElementsByClassName('blur-background')[0].style.display =
            'grid';
    });
}

var popup_buttons2 = document.querySelectorAll('.popup_button2');
for (var i = 0; i < popup_buttons2.length; i++) {
    popup_buttons2[i].addEventListener('click', function () {
        document.getElementsByClassName('blur-background')[0].style.display =
            'grid';
    });
}

var popup_buttons3 = document.querySelectorAll('.popup_button3');
for (var i = 0; i < popup_buttons3.length; i++) {
    popup_buttons3[i].addEventListener('click', function () {
        document.getElementsByClassName('blur-background')[0].style.display =
            'grid';
    });
}

var cathie_unfollow = document.querySelector('.hover_button1');
cathie_unfollow.addEventListener('click', function () {
    document.getElementById('box1Cathie').style.display = 'none';
});
