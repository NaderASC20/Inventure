...
const trendingContainer = document.getElementsByClassName("trending-container")[0]
const searchContainer = document.getElementsByClassName("search-container")[0]
const followingContainer = document.getElementsByClassName("following-container")[0]
...
document.getElementsByClassName("close")[0].addEventListener("click", closeBlur)
...
function openBlur() {
    document.getElementsByClassName("blur-background")[0].style.display = "grid"
}
